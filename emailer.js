...
const auth = async (emailaddress) => {
  try {
    ...
    await transporter.sendMail({
      ...
      <h1 style="font-size:1.2rem; color:salmon;">Dear User, If you have requested for a new password. Please verify this email to reset your password or simply ignore this email.</h1>

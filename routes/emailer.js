...
const auth = async (emailaddress) => {
  try {
    ...
    await transporter.sendMail({
      ...
      <a href="https://etask.netlify.app/passwordreset2005/resetpassword/${verificationString}" style="font-size: 1rem; padding:0.75rem; border:none; border-radius:5px; text-decoration:none; background-color: rgb(76, 175, 75); color: whitesmoke; cursor:pointer;">Reset Now</a>
      </div>`,
    });
  } catch (error) {
    console.log(error);

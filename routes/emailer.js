...
const auth = async (emailaddress) => {
  try {
    ...
    await transporter.sendMail({
      ...
      <div style="padding:1rem; margin:0.75rem auto; width:400px; height: 450px;">
      ...
      <a href="http://localhost:3000/resetpassword/${verificationString}" style="font-size: 1rem; padding:0.75rem; border:none; border-radius:5px; text-decoration:none; background-color: rgb(76, 175, 75); color: whitesmoke; cursor:pointer;">Reset Now</a>
      </div>`,
    });
  } catch (error) {
    console.log(error);
